 ...
 * @author DELL
 */
public class ReportPart extends javax.swing.JFrame {
...
//            break;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CETAK LAPORAN DATA PART");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportPart.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportPart().setVisible(true);
            }
        });
    }
