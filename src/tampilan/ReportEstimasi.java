...
public class ReportEstimasi extends javax.swing.JFrame {
...
//            break;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CETAK LAPORAN ESTIMASI BOOKING");
    ...
    private void bprintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bprintActionPerformed
        ...
        try{
            ...
            File file =new File ("src/Laporan/Laporan_Estimasi.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportEstimasi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportEstimasi().setVisible(true);
            }
        });
    }
